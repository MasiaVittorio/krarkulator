  ...
  Widget build(context) {
    ...
    return BodyCollapsedElement(
      ...
      child: SubSection(
        [
          Expanded(
            child: BlocVar.build6<int, int, int, int, int, int>(
              logic.birgis,
              logic.veyrans,
              logic.scoundrels,
              logic.artists,
              logic.bonusRounds,
              logic.prodigies,
              builder: (_, b, v, s, a, r, p) => ExtraButtons(
                children: [
                  IntToggle(
                    title: "Krarks",
                    ...
                    defaultVal: 0,
                    image: decoration(
                        "assets/images/arts/Krark_the_Thumbless.jpg"),
                  ...
                  if (v > 0)
                    IntToggle(
                      ...
                      image: decoration(
                          "assets/images/arts/Veyran_Voice_of_Duality.jpg"),
                      overrideTextColor: text,
                    )
                  else if (a > 0)
                    IntToggle(
                      ...
                      noNeedToRebuild: true,
                      image: decoration(
                          "assets/images/arts/Storm_Kiln_Artist.jpg"),
                      overrideTextColor: text,
                    )
                  else if (s > 0)
                    IntToggle(
                      ...
                      noNeedToRebuild: true,
                      image:
                          decoration("assets/images/arts/Tavern_Scoundrel.jpg"),
                      overrideTextColor: text,
                    )
                  else if (b > 0)
                    IntToggle(
                      ...
                      noNeedToRebuild: true,
                      image: decoration(
                          "assets/images/arts/Birgi_God_of_Storytelling.jpg"),
                      overrideTextColor: text,
                    )
                  else if (r > 0)
                    IntToggle(
                    ...
                    IntToggle(
                      ...
                      noNeedToRebuild: true,
                      image:
                          decoration("assets/images/arts/Harmonic_Prodigy.jpg"),
                      overrideTextColor: text,
                    )
                ],
